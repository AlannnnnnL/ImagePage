...
function tab() {
    //1.获取需要的标签
    allLis = $("tab_header").getElementsByTagName("li");
    doms = $("tab_content").getElementsByClassName("dom");
    var lastOne = 0; //最后一个被选中的板块的下标
...
function autoCreateImg() {
    ...
    for (var i = 0; i < 30; i++) {
        ...
        //绑定事件
        var wrapBox = $("dom_content").getElementsByClassName("box");
        var wrapPic = $("dom_content").getElementsByClassName("pic");
